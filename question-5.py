...
#As the question asks converting values into integer, use 'round' function
...
#If any of the three lengths is greater than the sum of the other two, you then can't form a triangle.
...
print("Can given input lengths form a triangle?")
print(answer) 